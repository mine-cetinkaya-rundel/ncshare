...
unvotes <- un_votes |>
  ...
  inner_join(un_roll_call_issues, by = "rcid", multiple = "all")
```
...
1.  Robinson D (2021). _unvotes: United Nations General Assembly Voting Data_. R package version 0.3.0, <https://CRAN.R-project.org/package=unvotes>.
